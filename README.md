...
|---------|----------|------|
| Entrega 1 | Demonstração do Notebook ML | [▶️ YouTube — Não Listado](https://youtu.be/QVhS12bamkE) |
| Entrega 2 | Comparação AWS Calculator | [▶️ YouTube — Não Listado](https://youtu.be/Tcc1cSV_J0k) |
...
AWS Virginia - images/print_aws_virginia.png
