...
|---------|----------|------|
| Entrega 1 | Demonstração do Notebook ML | [▶️ YouTube — Não Listado](#) |
| Entrega 2 | Comparação AWS Calculator | [▶️ YouTube — Não Listado](#) |

> *Substitua os `#` pelos links reais após gravar e subir ao YouTube.*
